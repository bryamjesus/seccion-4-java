...
public class OOSistemaNotas {
    public static void main(String[] args) {
        double[] claseMatematicas, claseHistoria, claseLenguaje;

        double sumNotasMatematicas = 0, sumNotasHistoria = 0, sumNotaLenguaje = 0;
        ...
        double promedioLenguaje = sumNotaLenguaje / claseLenguaje.length;

        System.out.println("Promedio clase matematicas" + (promedioMatematicas));
        System.out.println("Promedio clase matematicas" + (promedioHistoria));
        System.out.println("Promedio clase matematicas" + (promedioLenguaje));
